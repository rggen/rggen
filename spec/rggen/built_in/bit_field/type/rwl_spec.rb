  ...
  describe 'sv rtl' do
    ...
    it '出力ポート#value_outを持つ' do
      bit_fields = create_bit_fields do
        ...
        register do
          name 'register_0'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :rwl; initial_value 0; reference 'register_4.bit_field_0' }
          bit_field { name 'bit_field_1'; bit_assignment lsb: 8, width: 2; type :rwl; initial_value 0; reference 'register_4.bit_field_0' }
          bit_field { name 'bit_field_2'; bit_assignment lsb: 16, width: 4, sequence_size: 2, step: 8; type :rwl; initial_value 0; reference 'register_4.bit_field_0' }
        end

        register do
          name 'register_1'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 64; type :rwl; initial_value 0; reference 'register_4.bit_field_0' }
        end
    ...
    describe '#generate_code' do
      ...
      it 'rggen_bit_field_rwlをインスタンスするコードを出力する' do
        bit_fields = create_bit_fields do
          ...
          register do
            name 'register_0'
            bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :rwl; initial_value 0; reference 'register_5.bit_field_0' }
            bit_field { name 'bit_field_1'; bit_assignment lsb: 16, width: 16; type :rwl; initial_value 0xabcd; reference 'register_5.bit_field_0' }
          end

          register do
            name 'register_1'
            bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 64; type :rwl; initial_value 0; reference 'register_5.bit_field_0' }
          end

          register do
            name 'register_2'
            bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 4, sequence_size: 4, step: 8; type :rwl; initial_value 0; reference 'register_5.bit_field_0' }
          end
