    ...
    context '参照信号を持つ場合' do
      it '出力ポート#value_unmaskedを持つ' do
        bit_fields = create_bit_fields do
          ...
          register do
            name 'register_0'
            bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :w0c; initial_value 0; reference 'register_3.bit_field_0' }
            bit_field { name 'bit_field_1'; bit_assignment lsb: 8, width: 2; type :w0c; initial_value 0; reference 'register_3.bit_field_1' }
            bit_field { name 'bit_field_2'; bit_assignment lsb: 16, width: 4, sequence_size: 2, step: 8; type :w0c; initial_value 0; reference 'register_3.bit_field_2' }
          end
      ...
      it 'rggen_bit_field_w01cをインスタンスするコードを生成する' do
        bit_fields = create_bit_fields do
          ...
          register do
            name 'register_0'
            bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :w0c; initial_value 0 }
            bit_field { name 'bit_field_1'; bit_assignment lsb: 1; type :w0c; reference 'register_5.bit_field_0'; initial_value 1 }
            bit_field { name 'bit_field_2'; bit_assignment lsb: 8, width: 8; type :w0c; initial_value 0 }
            bit_field { name 'bit_field_3'; bit_assignment lsb: 16, width: 8; type :w0c; reference 'register_5.bit_field_2'; initial_value 0xab }
          end
          ...
          register do
            ...
            bit_field { name 'bit_field_1'; bit_assignment lsb: 4, width: 4, sequence_size: 4, step: 8; type :w0c; reference 'register_5.bit_field_1'; initial_value 0 }
          end
