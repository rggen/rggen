...
RSpec.describe 'bit_field/type/rwc' do
  ...
  describe 'register_map' do
    ...
    specify 'ビットフィール型は:rwc' do
      bit_fields = create_bit_fields do
        register do
          name :foo
          bit_field { name :foo_0; bit_assignment lsb: 0; type :rwc; initial_value 0 }
        end
      end
      expect(bit_fields[0]).to have_property(:type, :rwc)
    end
    ...
    specify '初期値の指定が必要' do
      expect {
        create_bit_fields do
          register do
            name :foo
            bit_field { name :foo_0; bit_assignment lsb: 0; type :rwc }
          end
        end
      ...
      specify '1ビット幅以上の参照ビットフィールドの指定が必要' do
        expect {
          create_bit_fields do
            register do
              name :foo
              bit_field { name :foo_0; bit_assignment lsb: 0, width: 2; type :rwc; initial_value 0; reference 'foo.foo_1' }
              bit_field { name :foo_1; bit_assignment lsb: 8, width: 1; type :rw; initial_value 0 }
            end

            register do
              name :bar
              bit_field { name :bar_0; bit_assignment lsb: 0, width: 1; type :rwc; initial_value 0; reference 'bar.bar_1' }
  ...
  describe 'sv rtl' do
    ...
    describe '#generate_code' do
      ...
      it 'rggen_bit_field_rwcをインスタンスするコードを出力する' do
        ...
        expect(bit_fields[2]).to generate_code(:bit_field, :top_down, <<~'CODE')
          rggen_bit_field_rwc #(
            ...
            .i_rst_n      (i_rst_n),
            .bit_field_if (bit_field_sub_if),
            .i_clear      (i_register_0_bit_field_2_clear),
        ...
        expect(bit_fields[4]).to generate_code(:bit_field, :top_down, <<~'CODE')
          rggen_bit_field_rwc #(
            ...
            .i_rst_n      (i_rst_n),
            .bit_field_if (bit_field_sub_if),
            .i_clear      (i_register_0_bit_field_4_clear[i]),
        ...
        expect(bit_fields[10]).to generate_code(:bit_field, :top_down, <<~'CODE')
          rggen_bit_field_rwc #(
            ...
            .i_rst_n      (i_rst_n),
            .bit_field_if (bit_field_sub_if),
            .i_clear      (i_register_1_bit_field_4_clear[i][j]),
        ...
        expect(bit_fields[16]).to generate_code(:bit_field, :top_down, <<~'CODE')
          rggen_bit_field_rwc #(
            ...
            .i_rst_n      (i_rst_n),
            .bit_field_if (bit_field_sub_if),
            .i_clear      (i_register_2_bit_field_4_clear[i][j][k]),
  ...
  describe 'sv ral' do
    ...
    specify 'アクセス属性はRW' do
      sv_ral = create_sv_ral do
        register do
          name 'register_0'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :rwc; initial_value 0 }
          bit_field { name 'bit_field_1'; bit_assignment lsb: 1; type :rwc; initial_value 0; reference 'register_1.bit_field_0' }
        end
