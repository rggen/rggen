    ...
    specify '初期値の指定が必要' do
      expect {
        create_bit_fields do
          register do
            name :foo
            bit_field { name :foo_0; bit_assignment lsb: 0; type :rwe; reference 'foo.foo_1' }
            bit_field { name :foo_1; bit_assignment lsb: 1; type :rw; initial_value 0 }
          end
        end
    ...
    specify '1ビット幅の参照ビットフィールドの指定が必要' do
      ...
      expect {
        create_bit_fields do
          register do
            name :foo
            bit_field { name :foo_0; bit_assignment lsb: 0, width: 2; type :rwe; initial_value 0 }
          end
        end
      }.to raise_register_map_error
  ...
  describe 'sv rtl' do
    ...
    it '出力ポート#value_outを持つ' do
      bit_fields = create_bit_fields do
        ...
        register do
          name 'register_0'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :rwe; initial_value 0; reference 'register_4.bit_field_0' }
          bit_field { name 'bit_field_1'; bit_assignment lsb: 8, width: 2; type :rwe; initial_value 0; reference 'register_4.bit_field_0' }
          bit_field { name 'bit_field_2'; bit_assignment lsb: 16, width: 4, sequence_size: 2, step: 8; type :rwe; initial_value 0; reference 'register_4.bit_field_0' }
        end

        register do
          name 'register_1'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 64; type :rwe; initial_value 0; reference 'register_4.bit_field_0' }
        end
    ...
    describe '#generate_code' do
      ...
      it 'rggen_bit_field_rweをインスタンスするコードを出力する' do
        bit_fields = create_bit_fields do
          ...
          register do
            name 'register_0'
            bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :rwe; initial_value 0; reference 'register_5.bit_field_0' }
            bit_field { name 'bit_field_1'; bit_assignment lsb: 16, width: 16; type :rwe; initial_value 0xabcd; reference 'register_5.bit_field_0' }
          end

          register do
            name 'register_1'
            bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 64; type :rwe; initial_value 0; reference 'register_5.bit_field_0' }
          end

          register do
            name 'register_2'
            bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 4, sequence_size: 4, step: 8; type :rwe; initial_value 0; reference 'register_5.bit_field_0' }
          end
  ...
  describe 'sv ral' do
    ...
    specify 'モデル名はrggen_ral_rwe_field' do
      sv_ral = create_sv_ral do
        register do
          name 'register_0'
          bit_field { name 'bit_field_0'; bit_assignment lsb: 0; type :rwe; initial_value 0; reference 'register_1.bit_field_0' }
        end
      ...
      expect(sv_ral.bit_fields[0].model_name).to eq 'rggen_ral_rwe_field #("register_1", "bit_field_0")'
    end
  end
end
