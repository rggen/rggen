...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'rggen-core', '~> 0.22.0'
  spec.add_runtime_dependency 'rggen-default-register-map', '~> 0.22.0'
  spec.add_runtime_dependency 'rggen-markdown', '~> 0.19.0'
  spec.add_runtime_dependency 'rggen-spreadsheet-loader', '~> 0.18.0'
  spec.add_runtime_dependency 'rggen-systemverilog', '~> 0.22.0'
