...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'rggen-c-header', '~> 0.7.0'
  spec.add_dependency 'rggen-core', '~> 0.36.0'
  spec.add_dependency 'rggen-default-register-map', '~> 0.36.0'
  spec.add_dependency 'rggen-markdown', '~> 0.28.0'
  spec.add_dependency 'rggen-spreadsheet-loader', '~> 0.27.0'
