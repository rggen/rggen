...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'rggen-core', '~> 0.20.0'
  spec.add_runtime_dependency 'rggen-default-register-map', '~> 0.20.0'
  spec.add_runtime_dependency 'rggen-markdown', '~> 0.17.0'
  spec.add_runtime_dependency 'rggen-spreadsheet-loader', '~> 0.16.0'
  spec.add_runtime_dependency 'rggen-systemverilog', '~> 0.20.0'
